...
const MembacaHuruf = ({navigation}) => {
    ...
    const handleSubmit = () => {
        const newKategori = Kategori + ' Tingkat Huruf';
        navigation.navigate('Hasil Asesmen', { Kategori: newKategori,scoreHuruf:score }); // Navigasi dengan Kategori yang sudah dimodifikasi
    };
    const dataSoalHuruf = useMemo(() => ([
